...
public class Runner_TaskHistory extends javax.swing.JFrame {
    
    private DefaultListModel<String> listModel = new DefaultListModel<>();
    private ArrayList<Task> rnTask;

    public Runner_TaskHistory() {
        try {
            initComponents();
            setVisible(true);
            
            populatelstTaskHistory();
    ...
    private void populatelstTaskHistory(){
            ...
            try {
                ...
                rnTask = hdlr.getRunnerTaskHistory(Runner_Dashboard.rnUser.getUserid());
                
                if (rnTask.isEmpty()){
                    listModel.addElement("No Accepted Tasks.");
                }else{            
                    for (Task task : rnTask) {
                        listModel.addElement(task.getTaskid()+ " - " + task.getTaskdate());
                    }
                }
            }
    ...
    private void initComponents() {
        ...
        lbl_MenuName.setText("Task History");
        ...
        lst_CurrentTask.addListSelectionListener(new javax.swing.event.ListSelectionListener() {
            public void valueChanged(javax.swing.event.ListSelectionEvent evt) {
                lst_CurrentTaskValueChanged(evt);
            }
        });
        ...
        pnl_RightLayout.setVerticalGroup(
            ...
            .addGroup(pnl_RightLayout.createSequentialGroup()
                ...
                .addComponent(lbl_MenuName)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(scrl_List, javax.swing.GroupLayout.DEFAULT_SIZE, 231, Short.MAX_VALUE)
                .addGap(18, 18, 18)
    ...
    private void lst_CurrentTaskValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_lst_CurrentTaskValueChanged
       Task selectedTask = rnTask.get(lst_CurrentTask.getSelectedIndex());
       String text = "Order ID:\n" + selectedTask.getOrderid()+ " \n" + "Location:\n"+selectedTask.getDeliveryLocation()+ "\n" + "Delivery Fee:\n"+selectedTask.getDeliveryFees();
       
       txt_Info.setText(text);
    }//GEN-LAST:event_lst_CurrentTaskValueChanged

 ...
 * @author User
 */
public class AdmMainPage extends javax.swing.JFrame {

    User AdmUser = new User();
    
    public AdmMainPage() throws IOException, ClassNotFoundException {
        initComponents();
        ...
        //lblDispOngOrd.setText(strnumorder);
        lblDispNumUser.setText(strnumuser);
    ...
    private void initComponents() {
        ...
        btnSearch.setText("Search Users");
        btnSearch.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(204, 204, 204), 3, true));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdmMainPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new AdmMainPage().setVisible(true);
                } catch (IOException ex) {
                    Logger.getLogger(AdmMainPage.class.getName()).log(Level.SEVERE, null, ex);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(AdmMainPage.class.getName()).log(Level.SEVERE, null, ex);

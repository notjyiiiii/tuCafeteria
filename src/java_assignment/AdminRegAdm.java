 ...
 * @author User
 */
public class AdminRegAdm extends javax.swing.JFrame {

    /**
     * Creates new form AdminRegAdm
     */
    public AdminRegAdm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        txtAdminID.setText("jTextField1");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminRegAdm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminRegAdm().setVisible(true);
            }
        });
    }

 ...
 * @author User
 */
public class AdminRegMain extends javax.swing.JFrame {

    /**
     * Creates new form AdminRegMain
     */
    public AdminRegMain() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminRegMain.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminRegMain().setVisible(true);
            }
        });
    }

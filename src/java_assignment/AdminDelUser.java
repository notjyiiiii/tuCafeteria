 ...
 * @author User
 */
public class AdminDelUser extends javax.swing.JFrame {

    /**
     * Creates new form AdminDelUser
     */
    public AdminDelUser() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblAdminName4.setText("User Role:");
        ...
        lblAdminName8.setText("User Role");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminDelUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminDelUser().setVisible(true);
            }
        });
    }
